...
在生命体具有多层HPV时，冲击波伤害会削减该生命体所有层数的HPV，但削减程度随着层数上升而下降。
...
化学腐蚀伤害会缓慢扣除受击目标的生命指示值，速度由攻击者天赋决定。
## 魔法攻击伤害分类
...
对于无机生命体单位，即使生物毒性伤害对其无效，但试图攻击他们依旧会判定造成了0点伤害并使其附上生物毒性状态效果。
