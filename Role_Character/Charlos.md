...
| 星级    | 描述                                                                                     |
| ----- | -------------------------------------------------------------------------------------- |
| ★     | Charlos 获得 1 点特殊护盾，受击判定失败时代为损失替代生命指示值，在施放终结技能 - 自我堙灭时恢复（暂定）                            |
| ★★    | Charlos 在向目标施加业力时无视目标48%防御力（暂定）                                                        |
| ★★★   | Charlos 冲刺时所穿过的目标会受到时长为 1 秒的业力打击伤害，伤害倍率取决于制式攻击 1 段倍率，并为 Charlos 恢复“情绪稳定”（暂定）           |
| ★★★★  | Charlos 攻击后的目标的业力清除值若达到该目标生命指示值上限的 20% ，则该目标在业力完全被清除后会被再次施加基于该目标剩余生命指示值的 40% 的业力打击（暂定） |
| ★★★★★ | Charlos 获得机械力伤害加成的“情绪稳定”阈值降低至0，且暴击几率超过100%的部分，每 1% 给予其 2% 的机械力伤害暴击加成（暂定）               |
...
- Charlos 后撤一步，同时令一个随机编号的意志力分身从自身分离并发动一次穿刺重击
	- 该攻击方式可以闪避即将受到的伤害
- Charlos 后撤一步施放一次穿刺重击，同时留下一个随机编号的意志力分身在原来的位置
	- 该攻击方式可以阻挡即将受到的伤害
		- 如果此伤害为无法常规阻挡的强力攻击，Charlos 仍然会强制阻挡伤害
			...
			- Charlos 会记录此次阻挡对自己造成的伤害值，并在下一次受击一起结算，施放终结技能可以清除记录值
...
- 增幅时间结束后，Charlos 被 ??? 射中的子弹命中，同时结算并清除增幅状态时命中目标所有的业力，并根据清除值与增幅期间命中目标的次数额外造成伤害，同时为 Charlos 恢复1次特殊阻挡的使用次数
...
| 秘技类型     | 描述                                                         |
| -------- | ---------------------------------------------------------- |
| 分支秘技 I   | Charlos 在“情绪稳定”超过60时获得一次破碎突刺，使得下一次普通攻击的机械力伤害提高==400%==（暂定） |
| 分支秘技 II  | （暂定）                                                       |
| 分支秘技 III | （暂定）                                                       |
| 强化秘技     |                                                            |
| 天启觉醒     |                                                            |
| 通用强化     | 暴击率、暴击伤害、伤害穿透、敏捷提高==10%==                                  |
